...
from data_process.voxel_generator import VoxelGenerator
from data_process import transformation
import config.kitti_config as cnf


class KittiDataset_Voxel(Dataset):
    ...
    def load_img_with_targets(self, index):
        ...
        # 生成鸟瞰图并将其转为tensor
        voxels, coors, num_points_per_voxel  = VoxelGenerator().generate(lidarData)
        ...
        x = {"voxels": voxels, "num_points": num_points_per_voxel, "coordinates": coors}

        return metadatas, x, targets
